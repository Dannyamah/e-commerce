                            ...
                            <aside class="shop-sidebar">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="sidebar-product-thumb">
                                                    <a href="shop-details.html"><img src="/assets/img/product/sidebar_product01.jpg" alt=""></a>
                                                </div>
                                            ...
                                            <li>
                                                <div class="sidebar-product-thumb">
                                                    <a href="shop-details.html"><img src="/assets/img/product/sidebar_product02.jpg" alt=""></a>
                                                </div>
                                                <div class="sidebar-product-content">
                                                    <div class="rating">
                                                        <i class="fas fa-star"></i>
                                            ...
                                            <li>
                                                <div class="sidebar-product-thumb">
                                                    <a href="shop-details.html"><img src="/assets/img/product/sidebar_product03.jpg" alt=""></a>
                                                </div>
                                                <div class="sidebar-product-content">
                                                    <div class="rating">
                                                        <i class="fas fa-star"></i>
                                ...
                                <div class="widget">
                                    <div class="shop-widget-banner text-center">
                                        <a href="shop.html"><img src="/assets/img/product/sidebar_shop_ad.jpg" alt=""></a>
                                    </div>
                                </div>
                            </aside>
                        </div>
                                    ...
                                    <div class="col-xl-3 col-md-4 col-sm-6">
                                        <div class="sp-product-item">
                                            <div class="sp-product-thumb">
                                                ...
                                                <a href="{{route('product-details', $product->id)}}"><img style="height: 143px" src="/storage/images/{{ $product->image }}" alt=""></a>
                                            </div>
                                            <div class="sp-product-content">
                                                ...
                                                <h6 class="title"><a href="{{route('product-details', $product->id)}}">{{$product->name}}</a></h6>
                                                <span class="product-status">IN Stock: {{$product->price}}</span>
